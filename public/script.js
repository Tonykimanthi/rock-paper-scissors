...
imageChose.forEach(function(image){
    image.addEventListener("click", function(){
        ...
        if(playerChose === computerChose){
            score.innerText = "Tie";
        }else if(playerChose.includes(gameImages[0]) && computerChose.includes(gameImages[1])){
            score.innerText = "You Lose";
            console.log("You Lose");
        }else if(playerChose.includes(gameImages[0]) && computerChose.includes(gameImages[2])){
            score.innerText = "You Win";
        }else if(playerChose.includes(gameImages[1]) && computerChose.includes(gameImages[0])){
            score.innerText = "You Win";
        }else if(playerChose.includes(gameImages[1]) && computerChose.includes(gameImages[2])){
            score.innerText = "You Lose";
        }else if(playerChose.includes(gameImages[2]) && computerChose.includes(gameImages[0])){
            score.innerText = "You Lose";
        }else if(playerChose.includes(gameImages[2]) && computerChose.includes(gameImages[1])){
            score.innerText = "You Win";
        }
